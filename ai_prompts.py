...
**强制规则：在所有初筛名单中，你必须极其苛刻地进行淘汰，最终只留下【不超过 6 只】你认为真正被综合人高度控盘、即将起爆的核心标的。**

**第二步：推演最小阻力路径（Path of Least Resistance）**
针对你选中的标的，根据近 15 日的切片（特别是极端缩量的日子和放量拒绝下跌的日子），推演主力已经把浮筹清洗到了什么程度，未来的上涨阻力在哪里。
...
---
*注：保持电报的冷酷、客观。只输出你选中的标的，不要提及被你淘汰的股票。*'''
