...
from scripts.build_market_universe_meta import _etf_entries, _market_entry
...
def test_market_entry_uses_market_currency() -> None:
    us = _market_entry("AAPL.US", "us")
    hk = _market_entry("00700.HK", "hk")
